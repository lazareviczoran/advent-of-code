...
type Map = BTreeMap<String, Vec<(String, usize)>>;
...
fn calculate_outcome(input: &BTreeMap<usize, Map>) -> usize {
    input
        .iter()
...
fn find_max_open_geodes(requirements: &Map) -> usize {
...
fn parse(filename: &str) -> BTreeMap<usize, Map> {
